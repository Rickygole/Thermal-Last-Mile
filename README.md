...
| Canopy | NLCD Tree Canopy Cover 2021 | MRLC | IN USE, eleven city ledger only, not the Houston model |
| Surface temperature | Landsat C2 L2 ST_B10, 10 pooled clear scenes 2018 to 2024 | USGS via Planetary Computer | IN USE, Houston heat field and city ledger |
